...
from functions.handlers_functions import cancel_f, \
...
@router.callback_query(lambda message: message.text ==['go_diagnostic', 'repeat_diagnostic'])
...
@router.callback_query(lambda message: message.text ==['backward'])
...
@router.callback_query(lambda message: message.text ==['forward'])
...
@router.callback_query(lambda message: message.text ==['return_to_symptoms'])
...
@router.callback_query(lambda message: message.text == SYMPTOMS_LIST)
...
@router.callback_query(lambda message: message.text == DISEASES)
...
@router.callback_query(lambda message: message.text ==['get_diagnosis'])
